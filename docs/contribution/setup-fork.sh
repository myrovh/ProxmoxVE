...
# upstream   https://github.com/myrovh/ProxmoxVE.git (fetch)
# upstream   https://github.com/myrovh/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/myrovh/ProxmoxVE"
echo ""
