...
source <(curl -fsSL https://raw.githubusercontent.com/myrovh/ProxmoxVE/refs/heads/main/misc/core.func)
...
for container in $CHOICE; do
  ...
  script=$(curl -fsSL https://raw.githubusercontent.com/myrovh/ProxmoxVE/main/ct/${service}.sh)
